...
<head>
    ...
    <meta name="description" content="Sitio desarrollado Marvel Fan Web">
    <meta name="copyright" content="© 2025 - Marvel Fan Web creada por Vanessa Rinaldi y Antonella Sosa - Diseño web">
    ...
    <main class="container my-5">
        ...
        <form method="post" class="mx-auto" style="max-width: 600px;">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Asunto" name="Asunto" placeholder="Motivo de contacto" required>
            </div>
